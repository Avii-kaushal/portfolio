    ...
    <header className="fixed w-full top-0 z-50 backdrop-blur-sm">
      <div className="mx-auto flex items-center justify-between p-8">
        <a href="#home" className="flex items-center gap-2.5 text-gray-900 no-underline dark:text-gray-100">
          <span className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 via-purple-500 to-cyan-500 text-sm font-semibold text-white shadow-lg">
            AK
          </span>
